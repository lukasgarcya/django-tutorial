...
\begin{document}
	...
	\section{Instalação}	
		\subsection{Python}
			\begin{frame}{Python}
				Por padrão o Python já vem instalado no Linux e no Mac OS. Não aconselho tentar usar em Windows.
			\end{frame}
		\subsection{Pip}
			...
			\begin{frame}[fragile]{Instalando o pip}
				...
				Este arquivo nada mais é do que um comandos em Python que irá baixar a última versão do pip e instalar para nós.
